...
> Dapat Mengidentifikasi komponen utama OS (kernel, system call, device driver, file system).
> Dapat Membandingkan model arsitektur OS (monolithic, layered, microkernel).
